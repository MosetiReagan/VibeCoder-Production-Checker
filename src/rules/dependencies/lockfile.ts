  ...
  async run(context) {
    ...
    return [
      createFinding({
        ...
        impact:
          'Installs and deployments may resolve different dependency versions, producing unstable builds and audits.',
        recommendation:
          'Commit the lockfile for your chosen package manager and install with frozen lockfile in CI and deployments.'
      })
    ];
  }
});
